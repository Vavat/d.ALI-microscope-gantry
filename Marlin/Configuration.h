...
#define STRING_CONFIG_H_AUTHOR "(Open source SBS plate microscope)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CCA Bio Microscope"
...
#define HEATER_6_MAXTEMP 140
#define HEATER_7_MAXTEMP 140
...
#define X_STEPS_PER_UNIT  (float)(200*16)/2.0
#define Y_STEPS_PER_UNIT  (float)(200*16)/2.0
#define Z_STEPS_PER_UNIT  (float)(200*16)/0.6
#define E_STEPS_PER_UNIT  (float)(200*16)/2.0
/**
 * Default Axis Steps Per Unit (linear=steps/mm, rotational=steps/°)
 * Override with M92
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { X_STEPS_PER_UNIT, Y_STEPS_PER_UNIT, Z_STEPS_PER_UNIT, E_STEPS_PER_UNIT }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 10, 10, 5, 25 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 10, 10, 5, 10000 }
...
//#define XY_AFTER_HOMING { 15, 10 }  // (mm) Move to an XY position after homing (and raising Z)
...
#define X_SCAN_SIZE   145
#define Y_SCAN_SIZE   85
#define Z_FOCUS_RANGE 15

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_SCAN_SIZE
#define Y_MAX_POS Y_SCAN_SIZE
#define Z_MAX_POS Z_FOCUS_RANGE
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define HOMING_FEEDRATE_MM_M { (5*60), (5*60), (5*60) }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS              93 // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
